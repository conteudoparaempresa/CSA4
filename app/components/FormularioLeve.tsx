...
// Componente extremamente leve para primeira dobra
export function FormularioLeve() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Carregar o formulário completo dinamicamente
    import("./FormularioCompleto").then(({ FormularioCompleto }) => {
      // Substituir este componente pelo completo
      const container = e.currentTarget.parentElement
      if (container) {
        container.innerHTML = ""
        // Renderizar o formulário completo
      }
    })
  }
