              ...
              <div className="flex items-center">
                <div className="h-12 w-auto relative">
                  <svg viewBox="0 0 900 262.31" className="h-full w-full fill-blue-600" aria-hidden="true">
                    <g>
                      <path d="M68.91,5.47c4.56,2.55,7.47,7.29,7.47,12.22,0,6.56-4.74,12.03-10.57,12.03-2.37,0-3.1-.18-9.66-2.74-3.83-1.46-6.75-2.01-9.66-2.01-11.49,0-19.69,9.66-19.69,23.15s8.2,22.97,20.42,22.97c3.28,0,6.93-.91,10.57-2.55,4\
